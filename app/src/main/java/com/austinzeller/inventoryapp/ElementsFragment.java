...
public class ElementsFragment extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        idTV = (TextView) findViewById(R.id.element_product_id_text_view);
        nameTV = (TextView) findViewById(R.id.element_product_name_text_view);
        priceTV = (TextView) findViewById(R.id.element_product_price_text_view);
        quantityTV = (TextView) findViewById(R.id.element_product_quantity_text_view);
        pictureTV = (TextView) findViewById(R.id.element_product_picture_text_view);
        soldTV = (TextView) findViewById(R.id.element_sold_text_view);

        sellB = (Button) findViewById(R.id.sell_elements_button);
        restockB = (Button) findViewById(R.id.restock_elements_button);
        deleteB = (Button) findViewById(R.id.delete_elements_button);
        stockB = (Button) findViewById(R.id.stock_elements_button);

        myDb = new ProductDbHelper(this);

        Log.e("the expense of i: ", "this stage");

        Intent thisIntent = getIntent();
        ArrayList<Integer> integers = thisIntent.getIntegerArrayListExtra("integerList");
        Integer i = integers.get(0);

        Log.e("the expense of i: ", i.toString());
        ...
        sellB.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent returnToMainIntent = new Intent(ElementsFragment.this,
                                MainActivity.class);
    ...
    public void restock(final String productName) {
        restockB.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Log.e("restore method", "restoring");

                        Intent mailIntent = new Intent(Intent.ACTION_SENDTO);
                        mailIntent.setData(Uri.parse("mailto:"));
                        mailIntent.putExtra(Intent.EXTRA_EMAIL, "Supplier@gmail.com");
                        mailIntent.putExtra(Intent.EXTRA_SUBJECT, ("Restore order for the product: "
                                + productName));
                        mailIntent.putExtra(Intent.EXTRA_TEXT, "Restore order for the product: "
                                + productName + "the amount needed is: ###");
    ...
    public void deleteProduct(final String idTVData) {
        deleteB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ElementsFragment.this);
                builder.setMessage("Do you want to delete this forever?"
